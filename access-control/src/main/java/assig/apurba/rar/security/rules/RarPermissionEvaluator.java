...
@Component
public class RarPermissionEvaluator implements PermissionEvaluator {
	private static Logger logger = LoggerFactory.getLogger(RarPermissionEvaluator.class);
	...
	public boolean hasPermission(Authentication authentication , Object targetDomainObject, Object permission) {
		...
		// List<String> userRoles = hasRole(authentication);
